...
위 예를 보면 T(n)의 최고차항의 차수가 big-O가 되는 것을 볼 수 있습니다. 알고리즘에서 이 big-O가 클 수록 연산 횟수가 많음을 뜻하고 따라서 성능이 나쁘다는 것을 보입니다.  
